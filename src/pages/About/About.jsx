    ...
    <>
      ...
      <section className="about-hero">
        <div className="about-container">
          ...
          >
            <span className="about-tag">🌿 About BiteCount AI</span>
            ...
            <p>
              BiteCount AI is an intelligent nutrition platform that combines
              Artificial Intelligence, nutritional science and modern technology
          ...
          >
            <div className="about-placeholder">
              ...
              <p>Project illustration will appear here later.</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mission">
        <div className="mission-grid">
          <div className="mission-card">
            ...
            <p>
              To make healthy living accessible through AI-powered nutrition
          ...
          <div className="mission-card">
            ...
            <p>
              To become a trusted AI assistant that helps people worldwide
      ...
      <section className="team">
        <h2>Meet Our Team</h2>
        <div className="project-guide-wrapper">
          <div className="member featured-member">
